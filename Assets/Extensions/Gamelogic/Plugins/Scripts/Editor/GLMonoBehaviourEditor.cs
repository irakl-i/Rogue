...
namespace Gamelogic.Extensions.Editor
{
	...
	/// <remarks>
	///     You can also add this behaviour to your own editor by extending from GLEditor, and
	///     calling DrawInspectorButtons.
	/// </remarks>
	[CustomEditor(typeof(GLMonoBehaviour), true), CanEditMultipleObjects]
