...
namespace Gamelogic.Extensions
{
	...
	///     Unity limitations). The exception, when thrown, indicates which class should have implemented the method, but
	///     hasn't.
	/// </summary>
	...
	/// <example>
	///     In the following example, the derived class does not override the method Method. When Method is called
