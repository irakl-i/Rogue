...
namespace Gamelogic.Extensions.Algorithms
{
	...
	public class DitherResponse
	{
		...
		public float this[float input]
		{
			get
			{
				var error = errorBuffer[frontIndex];
				var newT = input + noiseGenerator.Next() + error;

				var newValue = quantizer[newT];
				var newError = input + error - newValue;
