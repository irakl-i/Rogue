...
namespace Gamelogic.Extensions
{
	...
	/// <remarks>
	///     A loading bar is a typical use case. The loading bar should be displayed
	...
	public class StateTracker<TStateData>
	{
		...
		public IEnumerable<IStateToken<TStateData>> ActiveTokens => activeTokens.Cast<IStateToken<TStateData>>();
